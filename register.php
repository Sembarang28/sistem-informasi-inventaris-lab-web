<?php
  ...
  if(isset($_POST['register'])){
    ...
    $insert = mysqli_query($conn, "INSERT INTO users VALUE ('','$nama','$hp','$username','$password','user')");
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  <span class="d-none d-lg-block">Inventaris Laboratorium</span>
                </a>
              </div><!-- End Logo -->
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="" method="POST">
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="hp" class="form-control" id="yourEmail" required>
