<?php
  ...
  $merek = select("SELECT * FROM merek");

  if(isset($_POST['tambah'])){
    $nama = $_POST['namaMerek'];
    $keterangan = $_POST['keterangan'];

    $insert = mysqli_query($conn, "INSERT INTO merek VALUES ('','$nama','$keterangan')");
  ...
  if(isset($_POST['edit'])){
    ...
    $update = mysqli_query($conn, "UPDATE merek SET nama_merek = '$nama', keterangan = '$keterangan' WHERE id_merek = '$id'");
  ...
  if(isset($_POST['delete'])){
    ...
    $delete = mysqli_query($conn, "DELETE FROM merek WHERE id_merek = '$id'");
            ...
            <table class="table">
                  ...
                  <div class="modal-content">
                    ...
                    <form action="" method="post">
                      <div class="modal-body">
                        <input type="text" hidden name="id" class="form-control" value="<?= $row['id_merek'];?>">
                        <div class="form-group">
                          <label for="inputText" class="col-form-label">Nama Merek</label>
                          <input type="text" name="namaMerek" class="form-control" value="<?= $row['nama_merek']; ?>">
                        </div>
                        <div class="form-group">
              ...
              <div class="modal fade" id="delete<?= $i; ?>" tabindex="-1">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">Delete Merek</h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <form action="" method="POST">
                      <div class="modal-body">
                        ...
                        <h5 class="text-center text-dark">Apakah anda yakin akan menghapus data ini <br>
                          <span class="text-danger"><?= $row['id_merek']?> - <?= $row['nama_merek']?></span>
                        </h5>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
    ...
    <div class="modal-content">
      ...
      <form action="" method="post">
        <div class="modal-body">
          <div class="form-group">
            <label for="inputText" class="col-form-label">Nama Merek</label>
            <input type="text" name="namaMerek" class="form-control">
          </div>
          <div class="form-group">
            <label for="inputPassword" class="col-form-label">Keterangan</label>
