<?php
  ...
  $pengguna = select("SELECT * FROM users");
  ...
  if(isset($_POST['tambah'])){
    ...
    $insert = mysqli_query($conn, "INSERT INTO users VALUES ('','$nama','$hp','$username','$password','user')");
  ...
  if(isset($_POST['edit'])){
    ...
    $update = mysqli_query($conn, "UPDATE users SET nama = '$nama', hp = '$hp', username = '$username', 
                ...
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    ...
                    <form action="" method="post">
                      <input type="text" hidden name="id" value="<?= $row['id_user']; ?>">
                      <div class="modal-body">
                        ...
                        <div class="form-group">
                          <label for="inputText" class="col-form-label">TELP</label>
                          <input type="text" name="telp" class="form-control" value="<?= $row['hp'];?>">
                        </div>
                        <div class="form-group">
                    ...
                    <form action="" method="POST">
                      ...
                      <div class="modal-body">
                        <h5 class="text-center text-dark">Apakah anda yakin akan menghapus data ini <br>
                          <span class="text-danger"><?= $row['id_user']?> - <?= $row['nama']?></span>
                        </h5>
                      </div>
                      <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
